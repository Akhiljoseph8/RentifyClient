...
//Adding property
export const addProperty = async (data, header) => {
    return await commonApi("POST", `${base_url}/add-property`, data, header)
}

//getting all property
export const getProperty = async () => {
    return await commonApi("GET", `${base_url}/get-property`, "", "")
}
